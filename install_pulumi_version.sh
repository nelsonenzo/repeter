#!/bin/sh
## USAGE NELSON: ./install_pulumi_version.sh --version 1.14.1
## USAGE NELSON: ./install_pulumi_version.sh --version 2.1.0
## all available versions: https://www.pulumi.com/docs/get-started/install/versions/
set -e
